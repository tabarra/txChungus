...
const insults = [
    ...
    `Yo momma so stupid she bought a camera to record cable tv shows at home.`,
    ...
    `Yo momma so old and stupid she knew the Virgin Mary when she was 10 and said, "Lil Mary will never amount to anything".`,
    ...
    `Yo momma so short she models for trophy's.`,
    ...
    `Yo momma so nasty Ozzy Osbourne refused to bite her head off`,
    ...
    `Yo mamma so skinny, she hang glides with a Dorito`,
    `Yo mamma so stupid, she thinks hamburger helper comes with another person`,
    `Yo mamma so stupid, she thinks menopause is a button`,
    ...
    `Sometimes you feel like a nut, sometimes you don't, but even if you don't, you are still a nut.`,
    ...
    `When you were born, did the doctor slap the wrong end by mistake?`,
    `I'm looking forward to the pleasure of your company since I haven't had it yet.`,
    `When you pass away and people ask me what the cause of your death was, I'll say your stupidity.`,
    `Well I'll see you in my dreams - if I eat too much.`,
    `I've had many cases of love that were just infatuation, but this hate I feel for you is definitely the real thing.`,
    ...
    `You're just like a soda machine.  50 cents for the next generation!`,
    ...
    `You're so fat, when you were yellow shirts, helicopters try to land on you!`,
...
module.exports = {
    ...
    async execute(message, args, config) {
        ...
        const staticMessage = insults[Math.floor(Math.random() * insults.length)]
        const mentionString = message.mentions.users.map(x => `<@${x.id}>`).join(' ');
        const outMsg = (mentionString + `, ` + staticMessage).trim();
